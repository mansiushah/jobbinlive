          ...
          <div class="container">
            ...
            <div class="row">
              ...
              <div class="col s10 m6 l6">
                ...
                <h5 class="breadcrumbs-title mt-0 mb-0"><span>Skills</span></h5>
      ...
      <div class="col s12">
        ...
        <div class="card-content">
          ...
          <div id="view-validations">
            ...
            <form class="formValidate" id="formValidate" method="post" action="{{ route('skills.store') }}" enctype="multipart/form-data">
